  ...
  return (
    <>
      <Routes>
        ...
        <Route path='/RegistroTrilheiroSucessoTela' element={<RegistroTrilheiroSucessoTela />} />
        <Route path='/RegistroOpcoesTela' element={<RegistroOpcoesTela />} />
        <Route path='/RegistroGuiaTela' element={<RegistroGuiaTela />} />
        <Route path='/RegistroGuiaSucessoTela' element={<RegistroGuiaSucessoTela />} />
        <Route path="/endereco-guia/:idGuia" element={<RegistroGuiaEnderecoTela />} />
        <Route path="/RegistroGuiaBancariosTela/:idGuia" element={<RegistroGuiaBancariosTela />} />
