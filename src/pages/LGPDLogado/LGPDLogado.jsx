import '../LGPDLogado/LGPDLogado.css';
import Footer from '../../components/Footer/Footer';
import HeaderLogado from '../../components/HeaderLogado/HeaderLogado';

function LGPDLogadoTela() {
  return (
    <>
    <HeaderLogado />
      <main className="pnLGPDLogado">
        <div className="pnWallpaperLGPDLogado">
          <div className="pnWallpaperLGPDLogadoConteudo">
            <p>PRIVACIDADE</p>
            <h1>LGPD - Lei Geral de Proteção de Dados</h1>
          </div>
        </div>

        <section className="pnLGPDLogadoConteudo">
