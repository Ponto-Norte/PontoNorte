import '../TermosPrivacidadeLogado/TermosPrivacidadeLogado.css';
import Footer from '../../components/Footer/Footer';
import HeaderLogado from '../../components/HeaderLogado/HeaderLogado';

function TermosPrivacidadeLogadoTela() {
  return (
    <>
      <HeaderLogado />
      <main className="pnTermosPrivacidadeLogado">
        <div className="pnWallpaperTermosPrivacidadeLogado">
          <div className="pnWallpaperTermosPrivacidadeLogadoConteudo">
            <p>PRIVACIDADE</p>
            <h1>Termos e Privacidade</h1>
          </div>
        </div>

        <section className="pnTermosPrivacidadeLogadoConteudo">
          <h2>1. Introdução</h2>
          <p>
...
export default TermosPrivacidadeLogadoTela;
