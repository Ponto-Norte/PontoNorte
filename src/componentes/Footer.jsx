import PontoNorteLogo from '../componentes/PontoNorteLogo.png'
import './Footer.css'
    ...
    <div className='pn-container'>
      ...
      <div className="pn-footer-coluna-tres">
        ...
        <ul>
          ...
          <li><a href="">suporte@pontonorte.com.br</a></li>
        </ul>
      </div>
      <div className="pn-footer-coluna-quatro">
        <ul>
          <li><a href="">Rua Tito, 54</a></li>
          <li><a href="">CEP 05051-000</a></li>
          ...
          <div className="pn-redes-sociais">
            ...
            <a href=""><img src="https://img.icons8.com/material-outlined/50/FFFFFF/instagram-new.png" alt="instagram-new"/> </a>
          </div>
        </ul>
      </div>
    </div>
